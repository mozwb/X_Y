...
namespace X_Y
{
    ...
    {
        if (m_Impl)
            m_Impl->GetClientRect(left, top, right, bottom);
    }
    ...
    {
        if (m_Impl)
            m_Impl->SetLayeredAttribute(colorKey, alpha, flags);
    }

...
namespace X_Y {
    ...
    void Render::Submit(const Ref<Shader>& shader, const Ref<VertexArray>& vertexArray, const RenderMath::Mat4& transform)
    {
        shader->Bind();
    ...
    void Render::Submit(const Ref<Shader>& shader, int meshHandle, const RenderMath::Mat4& transform)
    {
